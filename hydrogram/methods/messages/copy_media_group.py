...
class CopyMediaGroup:
    async def copy_media_group(
        ...
        *,
        ...
        Returns:
            List of :obj:`~hydrogram.types.Message`: On success, a list of copied messages is returned.
        ...
        Example:
            .. code-block:: python
                ...
                await app.copy_media_group(to_chat, from_chat, 123, captions=["caption 1", None, ""])
        """
