...
class CallbackQuery(Object, Update):
    ...
    *inline_message_id* will be present. Exactly one of the fields *data* or *game_short_name* will be present.
    ...
    Parameters:
        ...
        message (:obj:`~hydrogram.types.Message`, *optional*):
        ...
        matches (List of regex Matches, *optional*):
            ...
            the data of this callback query. Only applicable when using :obj:`Filters.regex <hydrogram.Filters.regex>`.
    """
    ...
    async def _parse(client: hydrogram.Client, callback_query, users) -> CallbackQuery:
        ...
        if isinstance(callback_query, raw.types.UpdateBotCallbackQuery):
            ...
            message = client.message_cache[(chat_id, message_id)] or await client.get_messages(
                chat_id, message_id
            )
    ...
    async def answer(
        ...
        .. code-block:: python
            ...
            await client.answer_callback_query(callback_query.id, text="Hello", show_alert=True)
    ...
    async def edit_message_text(
        ...
        Returns:
            :obj:`~hydrogram.types.Message` | ``bool``: On success, if the edited message was sent by the bot, the edited
